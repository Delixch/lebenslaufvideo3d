...
const journey: RouteStop[] = [
  ...
  },
  {
    ...
    description:
      'Belieferte die Verkaufsstellen zuverl\u00e4ssig, kontrollierte die t\u00e4gliche Ladung und sorgte f\u00fcr Pflege und Unterhalt des zugeteilten Fahrzeugs.',
  },
  {
    id: '03',
...
export const ExperienceSection: React.FC = () => {
  ...
  return (
    <section
      id="experience"
      ref={containerRef}
      className="relative z-10 w-full bg-black text-[#E8DFD8] font-sans selection:bg-[#cbb59d] selection:text-black pt-8 md:pt-4 pb-24 fluid-gutter overflow-hidden scroll-mt-20 md:scroll-mt-0"
    >
