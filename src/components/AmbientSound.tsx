...
export const AmbientSound: React.FC = () => {
  ...
  return (
    <button
      ...
      className="fixed bottom-4 left-4 z-50 flex h-9 w-9 items-center justify-center rounded-full border border-[#8C6D4F]/60 bg-black/60 text-[#E8DFD8] backdrop-blur-sm transition-all duration-300 hover:border-[#D4AF37] hover:text-[#F7E7C4] lg:bottom-5 lg:left-5"
    >
      <span
