...
export const AboutSection: React.FC = () => {
  ...
  return (
    <section 
      id="about" 
      className="relative z-10 w-full min-h-screen bg-black text-[#E8DFD8] font-sans selection:bg-[#cbb59d] selection:text-black pt-8 md:pt-24 pb-24 lg:pb-32 fluid-gutter overflow-hidden flex items-center scroll-mt-20 md:scroll-mt-0"
    >
