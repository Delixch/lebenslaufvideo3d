...
export const SkillsSection: React.FC = () => {
  return (
    <section
      id="skills"
      className="relative z-10 w-full bg-black text-[#E8DFD8] font-sans selection:bg-[#cbb59d] selection:text-black pt-8 pb-24 fluid-gutter overflow-hidden flex flex-col justify-center scroll-mt-20 md:scroll-mt-0"
    >
      {/* Ambient Glows */}
